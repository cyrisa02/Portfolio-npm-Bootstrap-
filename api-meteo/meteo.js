...
function main() {
  fetch(
    "https://api.openweathermap.org/data/2.5/weather?q=Soissons&lang=fr&units=metric&appid=8417760ba8724050ae99eca6e6caa318 "
  )
    .then((res) => res.json())
    .then((data) => {
...
window
  .fetch(
    "https://geo.api.gouv.fr/communes?nom=Soissons&fields=population&format=json&geometry=centre "
  )
  .then((res) => res.json())
  .then((data) => {
